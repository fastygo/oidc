...
## 🛡️ Protecting Services with Authelia
...
3. Go to Coolify → Your Authelia service
4. Click **"Redeploy"**
...
5. ✅ Enable SMTP for password resets
6. ✅ Regularly update Authelia image
7. ✅ Review access control rules periodically
